# `usp_Audit_Fabric_Tables`

_Schema: `DW_Developer` · Warehouse: `ETL_Framework` · Family: `audit`_

_Modified: 2025-09-15 10:21:52.167000 · Code size: 2,925 chars_
...
BEGIN
    ...
    BEGIN TRY
	    IF OBJECT_ID('tempdb..#Temp_t') IS NOT NULL
			...
			t.name,
			'DELTA' as StorageType, -- Default to HEAP for Fabric
			t.create_date,
...
-- … [10 more lines truncated, full body in data/06-procs-raw.json] --
```
