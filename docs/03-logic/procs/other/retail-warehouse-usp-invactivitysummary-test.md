# `usp_InvActivitySummary_Test`

_Schema: `Retail_OOM_Enh` · Warehouse: `Retail_Warehouse` · Family: `other`_

_Modified: 2026-01-21 21:48:08.220000 · Code size: 13,816 chars_
...
```sql
CREATE   PROCEDURE [Retail_OOM_Enh].[usp_InvActivitySummary_Test]
AS
BEGIN
    ...
    BEGIN TRY
        ...
        WHERE LocationGroupID = 'DC'
            ...
            AND  CAST(TransDate AS DATE) >= GETDATE() - 1
