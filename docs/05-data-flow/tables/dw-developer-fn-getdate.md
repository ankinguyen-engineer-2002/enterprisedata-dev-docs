...
```mermaid
graph LR
    T["DW_Developer.fn_GetDate"]:::tbl
    T -- read by --> r_etl-framework-dw-dev["⚙️ ETL_Framework.DW_Developer.Usp_CreateTab"]
    T -- read by --> r_etl-framework-dw-dev["⚙️ ETL_Framework.DW_Developer.Usp_CreateTab"]
    T -- read by --> r_etl-framework-dw-dev["⚙️ ETL_Framework.DW_Developer.Usp_CreateTab"]
    T -- read by --> r_etl-framework-dw-dev["⚙️ ETL_Framework.DW_Developer.Usp_WriteTabl"]
...
- ⚙️ `ETL_Framework.DW_Developer.usp_UpdateTableDictionary_UpdateLog_RadarSync`
